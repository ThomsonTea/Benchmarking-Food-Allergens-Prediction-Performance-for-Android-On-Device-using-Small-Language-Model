...
object MetricsCalculator {
    ...
    data class Metrics(
        ...
        val recall: Double,
        val f1Score: Double,
        val accuracy: Double,  // ← NEW: ACCURACY METRIC
    ...
    fun calculateMetrics(
        ...
        // Calculate confusion matrix for each allergen
        var tp = 0
        var fp = 0
        var fn = 0
        var tn = 0
        ...
        // ============================================
        // ✅ CALCULATE ACCURACY (NEW!)
        // ============================================
        val accuracy = (tp + tn).toDouble() / (tp + fp + fn + tn)
        // This is the overall correctness across all 9 allergen labels
        // ============================================
        ...
        val hallucinatedAllergens = checkHallucinations(predSet, ingredients)

        // Over-Prediction Detection
        val overPredictedAllergens = (predSet - gtSet).sorted().joinToString(", ")
        ...
        return Metrics(
            ...
            recall = recall,
            f1Score = f1Score,
            accuracy = accuracy,  // ← NEW: Return accuracy
            isExactMatch = isExactMatch,
            hammingLoss = hammingLoss,
            fnr = fnr,
            hasHallucination = hallucinatedAllergens.isNotEmpty(),
            hallucinatedAllergens = hallucinatedAllergens,
            hasOverPrediction = overPredictedAllergens.isNotEmpty(),
            overPredictedAllergens = overPredictedAllergens,
    ...
    private fun checkHallucinations(predicted: Set<String>, ingredients: String): String {
        ...
        return hallucinated.sorted().joinToString(", ")
    }
}
